...
| `analysis/signals/registry.json` | Universal signal catalog — 234 signals, layer 1/2/3 tagged; all Layer 1 signals have compute specs (SIBC + ATM/POS). Counts here are checked by `reconcile.py` |
